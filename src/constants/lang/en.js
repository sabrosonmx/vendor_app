...
Amount`,
  ...
  YOUR_EMAIL_PHONE: 'Enter Email Id/Phone number',
  ...
  ENTER_EMAIL_OR_PHONE_NUMBER_WITH_COUNTRY_CODE:
    'Enter mail / phone number with country code',
...
EDIT_FOR_ALL:"Edit for all",
  ...
  MINIMAL_RENTAL_DAYS: 'Minimal Rental Days (optional)',
  ALL: 'All',
  UPCOMING_RENTS: 'Upcoming rents',
  ONGOING_RENTS: 'Ongoing rents',
  CARDS: 'Cards',
  ADD_AN_ITEM_FOR_RENT: "Add an item for rent",
  LENT_BY: "Lent by",
  PICK_UP: "Pick up",
  DROP_OFF: "Drop off",
  ...
  THE_ORDER_HAS_ALREADY_BEEN_ACCEPTED:"The order has already been accepted",
  //atlantic
  ...
  VENDOR_SCHEDULING :"Vendor Scheduling",
  ADD_SLOT:'Add Slot',
  Slot:"Slot",
  START_TIME:`Start Time (24 hours Format)`,
  END_TIME:' End Time (24 hours Format)',
  SLOTS_FOR:" Slot for",
  DAY:"Days",
  DATE:"Date",
  MONDAY:"Monday",
  ...
  SATURDAY:"Saturday",
  SUNDAY:"Sunday",
  SELECT_DAYS_OF_WEEK:" Select Days of weeks",
  CLOSE:'close',
  SAVE:"Save",
