export default {
  ...
  WALLET: 'Monedero',
  ADD_MONEY: 'agregar dinero a wallet',
  AVAILABLE_BALANCE: 'dinero electronico disponible',
  ...
  LOGOUT_SURE_MSG: 'BUDDY ¿Estás seguro de que quieres salir?',
  ...
  DOYOUWANTTOGIVEATIP: 'Agregar Propina',
  RENEW: 'Renovar',
  ORDER_CART: 'Pedidos',
  ...
  HEY_MSG: '¡Hola!',
  GREETING_MSG: 'busca lo que se te antoje',
  ...
  DARK: 'Oscuro',
  NOW: 'Ahora',
  SCHEDULE_ORDER: 'Programar orden pal rato',
  ...
  YOUR_ORDER_HAS_BEEN_SUBMITTED:
    '!Ahuevo, tu pedido ha sido enviado a nuestro socio compadre!',
  ...
  SELL_WHEN_OUT_STOCK: 'Vender cuando no haya existencias',
  MINIMUM_ORDER_COUNT: 'Recuento mínimo de pedidos',
  BATCH_COUNT: 'Recuento de lotes',
