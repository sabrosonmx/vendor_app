export default {
    ...
    DELETE_STORE:"Eliminar horario",
    
EDIT_FOR_ALL:"Editar para todos los",
    MAX_25: 'Máx. 25',
    ...
    VENDOR_NAME: 'Nombre del negocio',
    WEBSITE: 'Sitio WEB',
  ...
  ENTER_YOUR_EMAIL:"Enter your email",
    ...
    CANCELLED_ORDER: 'Cancelados',
    DELIVERED_ORDERS: 'Terminados',
    ACCOUNT: 'Mi Perfil',
    CONFIRMED: 'Aceptados',
    ...
    ORDERS: 'Pedidos',
    ORDER_CANCELLED: 'Cancelados Pedidos',
    ...
    VENDOR_SCHEDULING:'Horarios',
    ADD_SLOT:"Agregar horario",
    Slot:"Horario",
 
    START_TIME:`Hora de apertura (Formato de 24hrs)`,
    END_TIME:'Hora de cierre (Fomato de 24hrs)',
    SLOTS_FOR:"Aplica para",
    DAY:"Días",
    DATE:"Fecha",
    MONDAY:"Lunes",
    TUESDAY:"Martes",
    ...
    SATURDAY:"Sábado",
    SUNDAY:"Domingo",
    SELECT_DAYS_OF_WEEK:"Seleccionar dias de la Semana",
    CLOSES:'Cerrar',
    SAVE:"Guardar",
